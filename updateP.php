                ...
                <div class="row">
                    <div class=" col-xl-6 mx-auto">
                        <div class="bg-primary-soft p-4 p-sm-5 border border- shadow mt-3">
                            ...
                            <h1 class="text-center my-4 ">Update your Profile</h1>
                            <!-- form -->
                            <form action="updateInfo.php" method="POST" enctype="multipart/form-data">
                            <div class="">
                                    <label for="uname" class="form-label mb-3">Enter Your Username:</label>
                                    <input type="text" id="uname" name="uname" required/>
                                </div>  
                                <div class="mb-3">
                                    <label for="avatar" class="form-label ">Update profile picture
                                        Picture</label>
                                    <input type="file" id="avatar" name="img1" accept="image/png,image/jpeg" />
                                </div>
                                <div class="mb-3">
                                    <label for="work" class="form-label ">Update Image of your past work</label>
                                ...
                                <div class="aboutUser mb-4">
                                    ...
                                    <textarea type="text" name="about" class="form-control" id="abt">
                                    </textarea>
                                </div>
                                <div class="mb-3">
                                    <h4>
                                        <label for="exampleInputUserName" class="form-label ">Update links of
                                ...
                                <div class="Links-user mb-3 ">
                                    <label for="instagramuser" class="insta-label">
                                        Instagram</label><br>
                                        <input type="url" id="instagramuser" name="link1" accept="href" />
                                </div>
                                <div class="Links-user mb-3">
                                    <label for="fbuser" class="insta-label">
                                        FaceBook</label><br>
                                    <input type="url" id="fbuser" name="link2" accept="href" />
                                </div>
                                <div class="Links-user mb-3">
                                    <label for="tw" class="insta-label">
                                        Twitter </label><br>
                                    <input type="url" id="tw" name="link3" accept="href" />
                                </div>
                                <div class="Links-user mb-3">
                                    <label for="li" class="insta-label">
                                        LinkedIn</label><br>
                                    <input type="url" id="li" name="link4" accept="href" />
                                </div>
                                <div class="Links-user mb-3">
                                    <label for="gh" class="insta-label">
                                        Github</label><br>
                                    <input type="url" id="gh" name="link5" accept="href" />
                                </div>
                                
                                <div class="submit text-center">
                                    <button type="submit" name="submitU" class="btn btn-primary mt-2"
